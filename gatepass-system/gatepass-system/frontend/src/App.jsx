...
import { startOfflineSync } from "./offlineQueue";

export default function App() {
  // Runs for the lifetime of the app, regardless of which page is open —
  // retries any queued offline sign-ins on reconnect and on a timer.
